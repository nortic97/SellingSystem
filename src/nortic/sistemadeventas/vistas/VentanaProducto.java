...
import nortic.sistemadeventas.modelos.Evento;
...
import nortic.sistemadeventas.dao.ProductoDAO;
import nortic.sistemadeventas.dao.VentaDAO;
import nortic.sistemadeventas.reportes.Excel;
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(lbl_id, javax.swing.GroupLayout.DEFAULT_SIZE, 295, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        ...
        if ("".equals(txt_codigo.getText()) || "".equals(txt_nombre.getText()) || "".equals(txt_stock.getText()) || "".equals(combo_proveedor.getSelectedItem())) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                ...
                prodaux = pdao.BuscarProductos(cod);
                String nombre = prodaux.getNombre();
